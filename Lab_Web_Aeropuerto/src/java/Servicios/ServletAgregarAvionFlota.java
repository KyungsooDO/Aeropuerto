 ...
 */
@WebServlet(
        name = "ServletAgregarAvionFlota",
        urlPatterns = {"/ServletAgregarAvionFlota"}
)

@MultipartConfig
public class ServletAgregarAvionFlota extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletAgregarAvionFlota.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
