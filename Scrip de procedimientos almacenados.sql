...
delimiter $$
create procedure obtener_ciudad_por_nombre (in c_nombre varchar(50))
begin
select* from ciudad
...
delimiter $$
create procedure agregar_tipoavion (in t_idTipoAvion varchar(50),in t_modelo varchar(50),in t_marca varchar(50),in t_ano varchar(50),in t_cantidadAsientos int, t_cantidadFilas int, t_cantidadColumnas int)
begin
insert into tipoavion (idTipoAvion,modelo,marca,ano,cantidadAsientos,cantidadFilas,cantidadColumnas)
values (t_idTipoAvion,t_modelo,t_marca,t_ano,t_cantidadAsientos,t_cantidadFilas,t_cantidadColumnas);
end$$
delimiter $$

delimiter $$
create procedure actualizar_tipoavion (in t_modelo varchar(50),in t_marca varchar(50),in t_ano varchar(50),in t_cantidadAsientos int, t_cantidadFilas int, t_cantidadColumnas int,in t_idTipoAvion varchar(50))
begin
update tipoavion set modelo = t_modelo, marca = t_marca,ano = t_ano,cantidadAsientos = t_cantidadAsientos, cantidadFilas = t_cantidadFilas, cantidadColumnas = t_cantidadColumnas
...
delimiter $$
create procedure delimiter $$
create procedure buscar_vuelo_origen_destino (in v_origen varchar(2),in v_destino varchar(2))
begin
select* from vuelo
where origen = v_origen and destino = v_destino;
end$$
delimiter $$


call buscar_vuelo_origen_destino("02","03");

delimiter $$
create procedure obtener_ciudad_por_nombre (in a_nombre varchar(50))
begin
select* from ciudad
...
call obtener_ciudad_por_nombre("SJ");
...
delimiter $$
create procedure delimiter $$
create procedure obtener_usuario_clave_id (in u_id varchar(50),in u_clave varchar(50))
begin
select* from usuario
