...
public class Usuario {
    ...
    public Usuario(String idUsuario, String nombre, String contraseña, String apellido, String rol, String correoElectronico, Date fechaNacimiento, String direccion, int telefonoTrabajo, int telefonoCelular) {
        this.idUsuario = idUsuario;
        this.nombre = nombre;
